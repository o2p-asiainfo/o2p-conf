var App = function() {
    ...
    var handleCheckBox = function() {
        ...
        $('body').on('change', 'input[type="checkbox"].checkboxes', function() {
    ...
    return {
        ...
        validator: function() {
            ...
            $('body').on('change', ':input[stype]', function() {
                var $this = $(this);
            ...
            $('body').on('blur', ':input[stype]', function() {
                var $this = $(this);
                var stype = $this.attr('stype');
                switch (stype) {
                    case 'string':
        ...
        */
        ...
        urls: {
            ...
            //cacheobj  缓存工程
            cacheList:'./conf/messageFlow/getCacheStrategyList.shtml',//messageFlow/getCacheStrategyList.shtml
			cacheObjList:'./conf/messageFlow/getCacheStrategyById.shtml',//messageFlow/getCacheStrategyById.shtml
			cacheDelById:'./conf/messageFlow/delCacheStrategyById.shtml',
			cacheAddStrategy:'./conf/messageFlow/addCacheStrategy.shtml',
			cacheUpdateStrategy:'./conf/messageFlow/updateCacheStrategy.shtml',
			checkCacheKey:'./conf/messageFlow/checkCacheKeyIsExist.shtml',
        },
    }
}();
