...
<div class="contentWarp">
      ...
      <img src="../resource/blue/images/module-path.png" />
      <s:property value="%{getText('eaap.op2.conf.pardmix.desc')}"/>
      </div>
    </div>
    		...
    		<tr>
    			...
    			<tr>
    				<td  colspan="6"   align="center">
    					<a class="button-base button-middle" title="<s:property value="%{getText('eaap.op2.conf.manager.auth.return')}"/>" href="javascript:history.go(-1);">
						  	<span class="button-text"><s:property value="%{getText('eaap.op2.conf.manager.auth.return')}"/></span>
						</a>
