...
<head>
	...
	title[2]='<s:property value="%{getText('eaap.op2.portal.prov.contractBasic')}" />';
	title[3]='<s:property value="%{getText('eaap.op2.conf.compregauditing.isBase')}" />';
	title[4]='<s:property value="%{getText('eaap.op2.portal.prov.contractStatu')}" />';
	title[5]='<s:property value="%{getText('eaap.op2.portal.prov.StateDate')}" />';
...
<div style=" clear:both;">
		<ui:gridEasy columns="cols" iconCls="icon-save" sortName="code" singleSelect="true" id="contractList" remoteSort="false" sortOrder="desc"  onClickCell="true" toolbar="true"
			...
			frozenColumns="true" rownumbers="true"   method="eaap-op2-conf-contract-ContractAction.getContractList">
			...
			<ui:gridEasyColumn width="300" index="2" title="2" field="BASENAME" hidden="false"   align="center"></ui:gridEasyColumn>
			<ui:gridEasyColumn width="100" index="3" title="3" field="ISBASE" hidden="false"   align="center" formatter="true" formatterMethod="formatterForBase"></ui:gridEasyColumn>
			<ui:gridEasyColumn width="150" index="4" title="4" field="STATE" hidden="false"   align="center" formatter="true" formatterMethod="formatterForState"></ui:gridEasyColumn>
			<ui:gridEasyColumn width="190" index="5" title="5" field="CREATETIME" hidden="false"   align="center"></ui:gridEasyColumn>
			<ui:gridEasyColumn width="100" index="6" title="6" field="CONTRACTID" hidden="true"   align="center"></ui:gridEasyColumn>
		</ui:gridEasy> 
</div>
</div>
</div>
