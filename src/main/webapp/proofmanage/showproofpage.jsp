							...
							<div class="ui-widget">
								<div class="ui-widget">
									<intput type="hidden" id="hide_proofe_id"> <ui:select
										...
										listKey="PT_CD" listValue="PT_NAME" value="${pt_cd}"></ui:select>
								</div>
							</div>
						</td>
					</tr>
        ...
        var title = [];
          ...
          title[5]='<s:property value="%{getText('eaap.op2.conf.manager.auth.statetime')}" />';
			...
			<ui:gridEasy columns="cols" iconCls="icon-save" sortName="code"
				...
				collapsible="false" queryParams="true" queryParamsData="${prooffId}"
				title="%{getText('eaap.op2.conf.server.supplier.controlStrategy')}"
				striped="true" pageList="10" pagination="true" frozenColumns="true"
				rownumbers="true"
				method="eaap-op2-conf-proofeffect-ProofEffectAction.getShowAttrValue">
				...
				<ui:gridEasyColumn width="180" index="2" title="2" field="ATTR_SPEC_CODE"
					hidden="false" align="center"></ui:gridEasyColumn>
				<ui:gridEasyColumn width="180" index="3" title="3" field="ATTR_VALUE"
					hidden="false" align="center"></ui:gridEasyColumn>
			</ui:gridEasy>
