	   ...
	   --%>
	 	...
	 	<table class="mgr-table">
			<tr>
	  		    ...
	  		    <div class="ui-widget"> 
	  				<div class="ui-widget">	  					  					
	  					<ui:inputText skin="${contextStyleTheme}" name="templateModel.csv_file_name" id="cvsFileName"  textSize="25" type="text" value="${cvsFileName}"></ui:inputText>
	  					<!--  
	   			...
	   			<td class="item-content">
	  				<div class="ui-widget">	  					  					
	  					<ui:inputText skin="${contextStyleTheme}" name="templateModel.field_separator" id="fieldSeparator"  textSize="25" type="text" value="${fieldSeparator}"></ui:inputText>	  					
	  				</div> 	
	   			</td>	 
	   		</tr>
	   		<tr>
	  			...
	  			<td class="item-content">
	  				<div class="ui-widget">	  					  					
	  					<ui:select skin="${contextStyleTheme}" name="templateModel.quote_mark" id="quotes"
										...
										listKey="key" listValue="value" value="${quotes}"></ui:select>
	  				</div>
	   			</td>
	   			...
	   			<td class="item-content">
	   				<div class="ui-widget">
	  				  <ui:select skin="${contextStyleTheme}" name="templateModel.first_line_type" id="firstLineType"
										...
										listKey="key" listValue="value" value="${firstLineType}"></ui:select>
	  				</div>  	
	   			</td>
	   		</tr>
	   		<tr>
	  			...
	  			<td class="item-content">
	  				<div class="ui-widget">	  					  					
	  					<ui:select skin="${contextStyleTheme}" name="templateModel.file_add_date" id="filePlusDate"
										list="listYN" width="157" emptyOption="true"
										listKey="key" listValue="value" value="${filePlusDate}"></ui:select>
	  				</div>
	   			</td>
	   			<td class="item"><s:property value="%{getText('eaap.op2.conf.messageFlow.dateFormat')}" />:</td>
	   			<td class="item-content">
	   				<div class="ui-widget">
	  				  <ui:inputText skin="${contextStyleTheme}" name="templateModel.date_format" id="dateFormat"  textSize="25" type="text" value="${dateFormat}"></ui:inputText>
	  				</div>  	
	   			</td>
	   		</tr>
	   		<tr>
	  			...
	  			<td class="item-content">
	  				<div class="ui-widget">	  					  					
	  					<ui:inputText skin="${contextStyleTheme}" name="templateModel.separator_name_and_date" id="fileAndDateSep"  textSize="25" type="text" value="${fileAndDateSep}"></ui:inputText>
	  				</div>
	   			</td>
	   			<td class="item"><s:property value="%{getText('eaap.op2.conf.messageFlow.newLine')}" />:</td>
	   			<td class="item-content">
	   				<div class="ui-widget">
	  				  <ui:inputText skin="${contextStyleTheme}" name="templateModel.new_line_character" id="newLine"  textSize="25" type="text" value="${newLine}"></ui:inputText>
	  				</div>  	
	   			</td>
	   		</tr>
	   		<tr>
	  			...
	  			<td class="item-content"  colspan="3">
	  				<div class="ui-widget">	  					  					
	  					<ui:select skin="${contextStyleTheme}" name="templateModel.file_charset" id="fileEncode"
										...
										listKey="key" listValue="value" value="${fileEncode}"></ui:select>
	  				</div>
	   			</td>
	   		</tr>
	    </table>
...
function formSubmit(){
	...
	$('#templateForm').attr('action','../messageFlow/addSubmit.shtml');
	$('#templateForm').submit();
	//}
}
</script>
