 ...
 * @Last Modified time: 2016-08-17 20:36:22
 */
var transferData = FRONT_END_URL + "/front/transferData?url=";
var App = function() {
    ...
    return {
        ...
        transferI18nRes: function(parent) {
            ...
            i18nSpan.each(function(idx, item) {
                ...
                if (item.attr('i18n-set') && _.isString(item.attr('i18n-set'))) {
        ...
        */
        ...
        template: function(url, tmplID, containerID, params, callback) {
            var params, cb;
            if (arguments[3] && _.isObject(arguments[3])) {
                params = arguments[3];
            }
        ...
        blockUI: function(options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img style="" src="' + contextPath + '/resource/monitor/img/loading-spinner-grey.gif" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img style="" src="' + contextPath + '/resource/monitor/img/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        urls: {
            ...
            settlementDetail: 'resources/components/settlementDetail.shtml', //加载settlement详情模板            
            ...
            freeResource4PdtOfr: 'resources/components/freeResource4PdtOfr.shtml', //定价计划charge type
            ...
            product: transferData + '/sync/getSyncProductList', //同步product，返回查询到的product
            offer: transferData + '/sync/getSyncOfferList', //同步offer，返回查询到的offer          
            platformListData: transferData + '/sync/getPlatformList', //返回平台列表数据
            sync: transferData + '/sync/sync',
            systemList: transferData + '/sync/getSystemList',
            productDetailData: transferData + '/sync/getProductDetail',
            offerDetailData: transferData + '/sync/getOfferDetail',
            settlementDetailData: './mock/settlementDetailData.json',
            //offerDetailData: './offerDetailData.json',
            basicTariff4PdtOfrData: transferData + '/sync/getBasicPricePlan',
            recurringCharge4PdtOfrData: transferData + '/sync/getRecurringChargePlan',
            ratingDiscount4PdtOfrData: transferData + '/sync/getRatingDiscountPlan',
            oneTimeCharge4PdtOfrData: transferData + '/sync/getOneTimeChargePlan',
            billingDiscount4PdtOfrData: transferData + '/sync/getBillingDiscountPlan',
            freeResource4PdtOfrData: transferData + '/sync/getFreeResourcePlan',
            //settlementAggregationRuleData: './settlementAggregationRuleData.json', //settlement type
            settlementAggregationRuleData: transferData + '/sync/getSettlementAggregationRuleData',
            //settlementRecurringRuleData: './settlementRecurringRuleData.json', //settlement type
            settlementRecurringRuleData: transferData + '/sync/getSettlementRecurringRuleData',
            //settlementOneTimeChargeRuleData: './settlementOneTimeChargeRuleData.json', //settlement type
            settlementOneTimeChargeRuleData: transferData + '/sync/getSettlementOneTimeChargeRuleData',
            //settlementRulesData: './return.json', //settlement type
            settlementRulesData: transferData + '/sync/getSettlementRulesData',
            settlementRulesDataTmpl: transferData + '/sync/getSettlementRulesDataTmpl', //settlementRules.shtml页面
            saveSettlementRuleForm: transferData + '/sync/saveSettlementRuleForm', //保存SettlementRecurringRule提价表单
            //cacheobj  缓存工程
            ...
            //rti
            settlementRule: 'resources/components/settlementRule.html',
            settlementRuleData: transferData + "/rtiCtr/toSettlementRule.shtml",
            approval: 'resources/components/approval.html',
            approvalData: transferData + "/rtiCtr/toRtiAuditing.shtml",
            saveApproval: transferData + "/rtiCtr/submitAuditingResult.shtml",
            viewRtiRuleContent: 'resources/components/viewRtiRuleContent.html',
            viewRtiRuleContentData: transferData + "/rtiCtr/viewRtiRuleContentData.shtml",
            raiseThePrice: 'resources/components/raiseThePrice.html',
            raiseThePriceData: transferData + "/rtiCtr/getSettlementRulesData.shtml",
            saveRaiseThePriceData: transferData + "/rtiCtr/saveRaiseThePriceData.shtml"
        },
    }
}();
