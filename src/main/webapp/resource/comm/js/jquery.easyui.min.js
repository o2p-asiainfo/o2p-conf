...
if(opts.tools[i].iconCls == "icon-add"){
	t = $("<a href=\"javascript:void(0)\" onmouseover=\"this.className='panel-tool-icon-add-mouseover'\" onmouseout=\"this.className='icon-add'\"></a>");
}
t.addClass(opts.tools[i].iconCls).appendTo(tool);
...
if(opts.collapsible){
$("<a class=\"panel-tool-collapse\" onmouseover=\"this.className='panel-tool-collapse-mouseover'\" onmouseout=\"this.className='panel-tool-collapse'\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
...
if(opts.minimizable){
$("<a class=\"panel-tool-min\" onmouseover=\"this.className='panel-tool-min-mouseover'\" onmouseout=\"this.className='panel-tool-min'\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
_1fb(_1d8);
return false;
});
}
if(opts.maximizable){
$("<a class=\"panel-tool-max\" onmouseover=\"this.className='panel-tool-max-mouseover'\" onmouseout=\"this.className='panel-tool-max'\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
...
if(opts.closable){
$("<a class=\"panel-tool-close\" onmouseover=\"this.className='panel-tool-close-mouseover'\" onmouseout=\"this.className='panel-tool-close'\" href=\"javascript:void(0)\"></a>").appendTo(tool).bind("click",function(){
_1db(_1d8);
return false;
});
}
...
//add by chenwei modify  messager-button messager-body
//$(".messager-window").attr("style","display: block; width: 288px; left: 533px; top: -8px; z-index: 9005;");
//$(".window-shadow").attr("style","display: block; left: 533px; top: -8px; z-index: 9001; width: 300px; height: auto");
//$(".window-mask").attr("style","display:none");
