var ProductAttribute3 = function() {
    ...
    var handleDataTable = function() {
        ...
        $('#addType').click(function(){
        	...
        	var addVarType = $('#addVarType').val();
        	var addTypeName = $('#addTypeName').val();
        	if(addVarType==null || addVarType==''){
        		alert("please input variable map type");
        		return;
        	}
        	if(addTypeName==null || addTypeName==''){
        		alert("please input variable map name");
        		return;
        	}
        	
        	//var url = "../newadapter/addVarMapType.shtml?pageConsMapName="+addVarType+"&pageConsMapCD="+addTypeName;
	        ...
	        $.ajax({
        		    ...
        		    dataType:'json',
        		    data:{pageConsMapName:addVarType,pageConsMapCD:addTypeName},
        			success:function(msg){
        				if(msg.result == 'success'){
        					oTable.api().ajax.reload();
        				}else{
        					toastr.error(dataError);
        				}
        	         }
        	     });
