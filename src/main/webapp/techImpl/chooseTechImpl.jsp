...
<!--body start -->
	...
	<ui:form method="post" id="myform" name="myform" >
		...
		<dl class="noBorder" style="margin-top:3px;">
			<dt><s:property value="%{getText('eaap.op2.conf.techimpl.techImplName')}" />:</dt>
    		<dd style="width:150px;">
                <ui:inputText skin="${contextStyleTheme}" name="techImplName" id="techImplName"  value="%{getText('eaap.op2.conf.manager.auth.canlike')}" textSize="18"  style="float:left;"></ui:inputText>
			</db>
			
			<dt style="width:80px;"><s:property value="%{getText('eaap.op2.conf.techimpl.orgName')}" />:</dt>
			...
			<dt style="width:80px;"><s:property value="%{getText('eaap.op2.conf.techimpl.component')}" />:</dt>
    		<dd style="width:210px;">
  ...
  <table class="mgr-table" style="" id="confirm">
   <tr>
     <td  colspan="4"  align="center">    
        <ui:button skin="${contextStyleTheme}" text="%{getText('eaap.op2.conf.server.supplier.next')}"  onclick="chooseTechImplId();"></ui:button>
...
var myinput = document.getElementById("techImplName");
