...
<html>
  ...
  <body>
	   ...
	   <input type="hidden" name="dataSourceBean.dataSourceId" value="${map.DATA_SOURCE_ID }">
	 	...
	 	<table class="mgr-table">
			<tr>
	  		    ...
	  		    <div class="ui-widget"> 
	  				<div class="ui-widget">	  					  					
	  					<ui:inputText skin="${contextStyleTheme}" name="dataSourceBean.dataSourceName" id="dataSourceName"  textSize="25" type="text" value="${map.DATA_SOURCE_NAME}"></ui:inputText>
	  					<!--  
	   			...
	   			<td class="item-content">
	  				<div class="ui-widget">	  					  					
	  					<ui:inputText skin="${contextStyleTheme}"  id="myComponentName" name="myComponentName" value="${map.NAME }" readonly="true" style="float:left;"/>
    				    ...
    				    <input type="hidden" id="myComponentId" name="dataSourceBean.componentCode" value="${map.COMPONENT_ID }"/>                                   
	   		...
	   		<tr>
	  			...
	  			<td class="item-content">
	  				<div class="ui-widget">	  					  					
	  					 <ui:inputText skin="${contextStyleTheme}" name="dataSourceBean.tabSuffix" id="tabSuffix"  textSize="25" type="text" value="${map.TAB_SUFFIX }"></ui:inputText>
	  				</div>
	   			</td>
	   			<td class="item"><s:property value="%{getText('eaap.op2.conf.logserver.remarks')}" />:</td>
	   			<td class="item-content">
	   				<div class="ui-widget">
	  				  <ui:inputText skin="${contextStyleTheme}" name="dataSourceBean.remarks" id="remarks"  textSize="25" type="text" value="${map.REMARKS }"></ui:inputText>
	  				</div>  	
	   			</td>
	   		</tr>
	   		<tr>
	  			...
	  			<td class="item-content">
	  				<div class="ui-widget">	 			  					
	  					<ui:select skin="${contextStyleTheme}" name="dataSourceBean.isDefault" id="isDefault"
										...
										listKey="key" listValue="value" value="${map.IS_DEFAULT}"></ui:select>
	  				</div>
	   			</td>
	   			...
	   			<td class="item-content">
	   				<div class="ui-widget">
	  				  <ui:select skin="${contextStyleTheme}" name="dataSourceBean.isBeginInit" id="isBeginInit"
										...
										listKey="key" listValue="value" value="'${map.ISBEGININIT}'"></ui:select>
	  				</div>  	
	   			</td>
	   		</tr>
	    </table>
...
// 	$('#templateForm').attr('action','../logServer/updateSubmit.shtml');
// 	$('#templateForm').submit();
// 	}
		var form = document.getElementById("templateForm");
	  	if(comm_validators_check('group1')){
       	    form.action="updateSubmit.shtml";
       		form.submit();				
       	}	
}
</script>
