...
<html>
  ...
  <script type="text/javascript">
	 ...
	 function drawLine(){
		...
		var chart = new FusionCharts("../resource/comm/swf/MSLine.swf", "bizChart_Data", "100%", 260, "0", "1");
	 	$.ajax({
			url : "${contextPath}/monitorView/queryAllBizViewData.shtml",
			cache : false,
			async : false,
			dataType : "json",
			contentType:'application/x-www-form-urlencoded;charset=UTF-8',
			type  : 'POST',
			data  : {type:<%=type%>,sysErrTotal:sysErrTotal,bizTotal:bizTotal,bizErrTotal:bizErrTotal,yUnits:yUnits,allPerfomance:allPerfomance,csbPerfomance:csbPerfomance,supplyPerfomance:supplyPerfomance},
