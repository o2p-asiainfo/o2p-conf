...
var panelTitle="";
 jQuery(document).ready(function() {
	...
	App.init();
	Main.init_lineEchart("performanceChart");
	Main.init_gaugeEchart("performanceChart");
	setTimeout("initSetGauge()",4000);
	panelTitle= decodeURIComponent("<%=panelTitle%>");
...
<div class="portlet box blue">
	<div class="portlet-title">
		<div class="caption"  id="panelTitle"></div>
   		<div class="tools">
	            <a class="reload" href="javascript:;" data-target="performanceChart" data-url="${contextPath}/monitorView/getSysViewDataGauge.shtml?localTime={localTime}&timeOffset={timeOffset}"> </a>
		...
		<div class="s-dropdown-menu pull-right">
		        <a id="dp-system" href="javascript:;" data-toggle="dropdown" aria-haspopup="true" role="button" aria-expanded="false"> Dashboard <span class="caret"> </span> </a>
		        <ul class="dropdown-menu" role="menu" aria-labelledby="dp-system">
			         <li><a href="javascript:;"  onClick="javascript:setTimeout('initSetGauge()',3000);" data-url="${contextPath}/monitorView/getSysViewDataGauge.shtml?localTime={localTime}&timeOffset={timeOffset}">Dashboard</a> </li>
			         <li><a href="javascript:;"  onClick="javascript:setTimeout('initSetLine()',3000);" data-url="${contextPath}/monitorView/getSysViewDataLine.shtml?localTime={localTime}&timeOffset={timeOffset}">Graph</a> </li>
		        </ul>
		</div>   
	</div>
	<div class="portlet-body">
            <div id="performanceChart" style="height:299px"></div>
	</div>
</div>
</body>
</html>