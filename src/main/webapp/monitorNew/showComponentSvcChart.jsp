...
<%@ page import="org.apache.commons.lang3.StringEscapeUtils"%>
  <%
  	  String componentSvcId = StringEscapeUtils.escapeHtml4(request.getParameter("svcId"));
...
<script>
 ...
 function setPanelTitleWidth(){
		$("#panelTitle").width(window.document.body.offsetWidth -200);
 }
  ...
  <body>
          <div class="portlet box blue">
           <div class="portlet-title">
	            ...
	            <div class="tools">
	             	<a class="reload" href="javascript:;" data-target="lineEchart" data-url="${contextPath}/monitorView/getComponentSvcViewData.shtml?tabType=1&componentId=<%=componentId%>&componentSvcId=<%=componentSvcId%>&localTime={localTime}&timeOffset={timeOffset}"> </a>
	            ...
	            <div class="s-dropdown-menu pull-right">
		             ...
		             <ul class="dropdown-menu" role="menu" aria-labelledby="dp-system">
		              <li><a href="javascript:;" data-url="${contextPath}/monitorView/getComponentSvcViewData.shtml?tabType=1&componentId=<%=componentId%>&componentSvcId=<%=componentSvcId%>&localTime={localTime}&timeOffset={timeOffset}">Performance</a> </li>
		              <li><a href="javascript:;" data-url="${contextPath}/monitorView/getComponentSvcViewData.shtml?tabType=2&componentId=<%=componentId%>&componentSvcId=<%=componentSvcId%>&localTime={localTime}&timeOffset={timeOffset}">Service User</a> </li>
		              <li><a href="javascript:;" data-url="${contextPath}/monitorView/getComponentSvcViewData.shtml?tabType=3&componentId=<%=componentId%>&componentSvcId=<%=componentSvcId%>&localTime={localTime}&timeOffset={timeOffset}">Service Provider</a> </li>
		             </ul>
	            </div>
           </div>
           <div class="portlet-body">
            <div id="lineEchart" style="height:300px"></div>
           </div>
          </div>
  </body>
</html>