...
<script>
 ...
 function addPanel(){
	...
	var tipTitle		= decodeURIComponent("<%=tipTitle%>");
 	window.parent.addPanel("<%=componentId%>",panelTitle,tipTitle);
 }
 ...
 <body>
          <div class="portlet box blue">
           <div class="portlet-title">
	            ...
	            <div class="tools">
	             	<a class="reload" href="javascript:;" data-target="lineEchart" data-url="${contextPath}/monitorView/getSingleComponetData.shtml?tabType=1&componentId=<%=componentId%>&localTime={localTime}&timeOffset={timeOffset}"> </a>
	            ...
	            <div class="s-dropdown-menu pull-right">
		             ...
		             <ul class="dropdown-menu" role="menu" aria-labelledby="dp-system">
		              <li><a href="javascript:;" data-url="${contextPath}/monitorView/getSingleComponetData.shtml?tabType=1&componentId=<%=componentId%>&localTime={localTime}&timeOffset={timeOffset}">Performance</a> </li>
		              <li><a href="javascript:;" data-url="${contextPath}/monitorView/getSingleComponetData.shtml?tabType=2&componentId=<%=componentId%>&localTime={localTime}&timeOffset={timeOffset}">Service User</a> </li>
		              <li><a href="javascript:;" data-url="${contextPath}/monitorView/getSingleComponetData.shtml?tabType=3&componentId=<%=componentId%>&localTime={localTime}&timeOffset={timeOffset}">Service Provider</a> </li>
		             </ul>
	            </div>
           </div>
