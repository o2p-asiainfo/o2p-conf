...
<input id="reqRspFlag" name="reqRspFlag" value="${reqRspFlag}" type="hidden">
				<input type="hidden" name="fuzzyModel.fuzzyId" value="${fuzzyModel.fuzzyId }"/>
				<div class="module-path">
				...
				<table class="mgr-table">
					...
					<tr>
						...
						<td class="item-content" style="width: 80%;">
						 <ui:select
										...
										list="type" width="157" value="${fuzzyModel.fuzzyType}" disabled="true"
					...
					<td class="item-content" style="width: 80%;">
					<ui:inputText skin="${contextStyleTheme}"  id="fuzzySymbols" textSize="25" name="fuzzyModel.fuzzySymbols" value="${fuzzyModel.fuzzySymbols}"style="float:left;"/>		    
					</td>
				    </tr>
				    <tr id="Id_fuzzyStart">
				    <td class="item" style="width: 20%;"><font color="red">*</font><s:property value="%{getText('eaap.op2.conf.process.startingPosition')}" />:</td>
					<td class="item-content" style="width: 80%;">
					<ui:inputText skin="${contextStyleTheme}"  id="fuzzyStart" textSize="25" name="fuzzyModel.fuzzyStart" value="${fuzzyModel.fuzzyStart}"onchange="javascript:validateNum('fuzzyStart',this.value);"style="float:left;"/>		    
					</td>
				    </tr>
				    <tr id="Id_fuzzyEnd">
				    <td class="item" style="width: 20%;"><font color="red">*</font><s:property value="%{getText('eaap.op2.conf.process.endPosition')}" />:</td>
					<td class="item-content" style="width: 80%;">
					<ui:inputText skin="${contextStyleTheme}"  id="fuzzyEnd" textSize="25" name="fuzzyModel.fuzzyEnd" value="${fuzzyModel.fuzzyEnd}" onchange="javascript:validateNum('fuzzyEnd',this.value);"style="float:left;"/>		    
					</td>
				    </tr>
				</table>
			</ui:form>
...
function saveDate(){
	...
	$('#addproof').attr('action','../operatorlog/updateSubmitProcess.shtml');
	addproof.submit();
}
