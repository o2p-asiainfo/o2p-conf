...
public interface IServiceManagerServ {
    public String queryGridCount();//得到服务表的数据数目
    ...
    public List<Service> queryServiceChoice(Map map);//查询服务表有条件下
    public List<Service> selectServiceList(Map map);//查询服务列表
    public List<Service> queryService(Service service);//查询服务表
    public List<Map> queryAllConstractList(Map map);//查询所有的协议版本的信息
    public List<NodeDesc> queryNodeDesc(Map map);//查询节点描述表
    public String queryTreeGridCount(Map map);//查询所有树节点的数量
    public List<Map> queryDirectory(Map map);//查询所有的目录
    public List<Map> queryDirectoryById(Map map);//根据父节点ID查询所有的目录
    ...
    public String queryCountDirSerList(Map map);//根据目录和业务流程等等条件查出所有的数据的数目queryRegesiterSerList
    ...
    public List<SerInvokeIns> querySerInvokeIns(SerInvokeIns serInvokeIns);//查询服务调用实例
